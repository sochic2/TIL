...
const USERS = [
    { name : 'Thor'},
    { name : 'Steve Rogers'},
    { name : 'Tony Stark'},  // 첫번째 애만 뽑고 리턴되서 끝남
    { name : 'Tony Stark'},
...
// 5-1 PERSONS 중에 admin 권한을 가진 요소를 찾아서 admin 에 저장하자.
const PERSONS = [
    { id: 1, admin: false },
    { id: 2, admin: false },
    { id: 3, admin: true },
...
const admin = PERSONS.find( function(person) {
...
const hasSubmitted = USERSS.every(function (user) {
